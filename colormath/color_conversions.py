...
def XYZ_to_Lab(cobj, *args, **kwargs):
    ...
    if temp_x > color_constants.CIE_E:
        temp_x = math.pow(temp_x, __CIE_1_3)
    else:
        temp_x = (__CIE_1_3_29_6_POW_2 * temp_x) + (__CIE_4_29)

    if temp_y > color_constants.CIE_E:
        temp_y = math.pow(temp_y, __CIE_1_3)
    else:
        temp_y = (__CIE_1_3_29_6_POW_2* temp_y) + (__CIE_4_29)
   
    if temp_z > color_constants.CIE_E:
        temp_z = math.pow(temp_z, __CIE_1_3)
    else:
        temp_z = (__CIE_1_3_29_6_POW_2 * temp_z) + (__CIE_4_29)
